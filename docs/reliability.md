...
- Sell access policies map product/variant IDs to tier and fixed-term duration days, and a scheduled Convex job expires entitlements and triggers role revoke sync without waiting for new webhooks.
